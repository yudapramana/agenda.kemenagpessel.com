        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse order-3" id="navbarCollapse">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <router-link to="smart-calendar" class="nav-link">Smart Calendar</router-link>
                    </li>
                    <li class="nav-item">
                    ...
                    <li v-if="currentUser" class="nav-item">
                        <router-link to="schedule" class="nav-link">Kelola Jadwal</router-link>
                    </li>
